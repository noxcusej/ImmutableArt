...
function createSourceFile(uri, _content, _version, context) {
    ...
    const sfcTemplateScript = (0, useSfcTemplateScript_1.useSfcTemplateScript)(uri, document, (0, reactivity_1.computed)(() => descriptor.template), (0, reactivity_1.computed)(() => descriptor.scriptSetup), (0, reactivity_1.computed)(() => descriptor.styles), templateScriptData, sfcStyles.textDocuments, sfcStyles.sourceMaps, sfcTemplateData, sfcTemplateCompileResult, (0, reactivity_1.computed)(() => sfcStyles.textDocuments.value), sfcScriptForScriptLs.lang, context);

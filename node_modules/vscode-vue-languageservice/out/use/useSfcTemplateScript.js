...
function useSfcTemplateScript(vueUri, vueDoc, template, scriptSetup, styles, templateScriptData, styleDocuments, styleSourceMaps, templateData, sfcTemplateCompileResult, sfcStyles, scriptLang, context) {
    let version = 0;

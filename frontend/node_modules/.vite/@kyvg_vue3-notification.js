...
var script = defineComponent({
  ...
  methods: {
    ...
    notifyWrapperStyle(item) {
      return this.isVA ? void 0 : { transition: `all ${item.speed}ms` };
    },
    destroy(item) {
    ...
    getAnimation(index2, el) {
      var _a;
      const animation = (_a = this.animation) === null || _a === void 0 ? void 0 : _a[index2];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", {
    ...
    (openBlock(), createBlock(resolveDynamicComponent(_ctx.componentName), {
      ...
      _: 3
    }, 8, ["name", "onEnter", "onLeave", "onAfterLeave"]))
  ], 4);
}
...
var kyvg_vue3_notification_default = index;
export {
